...
class Users extends CRMEntity
{
	...
	public function load_user($user_password)
	{
		...
		$result = $this->db->requireSingleResult($query, [$usr_name], false);
	...
	{
		return ['FIRSTNAME', 'LASTNAME', 'USERNAME', 'SECONDARYEMAIL', 'TITLE', 'OFFICEPHONE', 'DEPARTMENT',
