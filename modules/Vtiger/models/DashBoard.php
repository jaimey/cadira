...
class Vtiger_DashBoard_Model extends Vtiger_Base_Model
{
	...
	public function getUserDefaultTab($userId)
	{
		...
		return ['id'=>$row['id'], 'tabname'=>$row['tabname'], 'sequence'=>$row['sequence'], 'isdefault'=>$row['isdefault']];
	}
	...
	public function addTab($tabName)
	{
		...
		return ['tabid'=>$db->getLastInsertID(), 'tabname'=>$tabName, 'sequence'=>$sequence];
	}
