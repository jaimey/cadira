...
class Vtiger_PackageUpdate extends Vtiger_PackageImport
{
	...
	public function update_Blocks($modulenode, $moduleInstance)
	{
		...
		foreach ($modulenode->blocks->block as $blocknode) {
			...
			if (! $blockInstance) {
				...
				$this->update_Block($blocknode, $blockInstance);
			}
	 ...
	 */
	public function update_Block($blocknode, $blockInstance)
	{
	...
	public function update_Fields($blocknode, $blockInstance, $moduleInstance)
	{
		...
		foreach ($blocknode->fields->field as $fieldnode) {
			...
			if (! $fieldInstance) {
				...
				$this->update_Field($blockInstance, $moduleInstance, $fieldnode, $fieldInstance);
			}
	 ...
	 */
	public function update_Field($blockInstance, $moduleInstance, $fieldnode, $fieldInstance)
	{
	...
	public function update_Events($modulenode, $moduleInstance)
	{
		...
		if (Vtiger_Event::hasSupport()) {
			foreach ($modulenode->events->event as $eventnode) {
				$this->update_Event($moduleInstance, $eventnode);
			}
		}
	}
	 ...
	 */
	public function update_Event($moduleInstance, $eventnode)
	{
	...
	public function update_RelatedLists($modulenode, $moduleInstance)
	{
		...
		foreach ($modulenode->relatedlists->relatedlist as $relatedlistnode) {
			$this->update_Relatedlist($moduleInstance, $relatedlistnode);
		}
	}
	 ...
	 */
	public function update_Relatedlist($moduleInstance, $relatedlistnode)
	{
