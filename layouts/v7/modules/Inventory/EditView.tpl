                ...
                <form class="form-horizontal recordEditView" id="EditView" name="edit" method="post" action="index.php" enctype="multipart/form-data">
                    <div class="editViewHeader">
                        ...
                        <div class="col-lg-12 col-md-12 col-lg-pull-0">
                                ...
                                {if $RECORD_ID neq ''}
                                    <h4 class="editHeader" style="margin-top:5px; margin-left:15px;" title="{vtranslate('LBL_EDITING', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)} {$RECORD_STRUCTURE_MODEL->getRecordName()}">{vtranslate('LBL_EDITING', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)} - {$RECORD_STRUCTURE_MODEL->getRecordName()}</h4>
                                {else}
                                    <h4 class="editHeader" style="margin-top:5px; margin-left:15px;">{vtranslate('LBL_CREATING_NEW', $MODULE)} {vtranslate($SINGLE_MODULE_NAME, $MODULE)}</h4>
                                {/if}
                            </div>
                        </div>
                    </div>
