...
spl_autoload_register(['Logger', 'autoload']);
...
class Logger
{
	 ...
	 *
	 * @param LoggerAppender|string $appender an appender name or a {@link LoggerAppender} instance.
	 */
	...
	public static function initialize()
	{
		...
		return $instance->configure(self::getHierarchy(), self::$configurationFile);
	}
